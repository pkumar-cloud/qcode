...
eg ./print-month-name.sh 1 should print January and ./print-month-name.sh 5 should print May. 
...
if [ -z $month_number ] #The -z flag checks whether a string is empty. Returns true if the string is empty, false if it contains something. 
then
